...
<!-- 압축하지 말 것. 다음 4 하위절로 분해를 권장:
     ### 직관 (Intuition)        — [필수] 사전지식 없이 이해되도록 2–4문단,
                                   인용·수식 없이 평이 산문 (STYLE §5-6/§5-8)
     ### 아키텍처                — 입력/출력, 모듈 분해
     ...
     답니다:
       ...
       (한글 해설 — 직관 먼저, 연결 산문 1–3문장. 영문 재진술 금지.
        인용은 prose 의 근거로 앞·뒤 어디든 배치 가능. STYLE §5-6/§5-8.)
...
<!-- 저자가 밝힌 약점 + 추론된 갭. 각 항목에 메커니즘·왜 중요한가를 1–2문장
     담론형으로 ("비판적 통찰" 품질, STYLE §5-8). 우리 스택 전이 위험 같은
     lab-specific 비판은 여기 말고 아래 ⚠️ 섹션에. -->
...
<!-- context/MASTER.md 기준. 어떤 P0–P5 / D1–D32 를 건드리는지,
