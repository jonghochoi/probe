...
- **방법론 레퍼런스 후보** — 데이터 품질 판별기(PU + log-π 대리 + DWBC 가중)는
  `analysis/_catalogs/` 의 학습 레시피 방법론 문서로 분리 정리할 가치가 있습니다
  (D21 보강 근거).
- context/MASTER.md 는 수정하지 않았습니다 — 위는 사람 판단을 위한 제안일 뿐입니다.

> 💡 base 매핑은 `/implement analysis/2605.18722/design.md [--foundry <name>]` 로 생성하실 수 있습니다. 기본 foundry 는 `lerobot` 입니다.
