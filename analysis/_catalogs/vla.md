...
> 적어둠.
>
> v0.4 (2026-05). 공통 컬럼 표준 + 카드 schema 는
> `analysis/_catalogs/README.md` §2 참고. 상단 **scan 표** + 하단
> **per-VLA `<details>` 카드** 하이브리드 — dataset 와 동일 패턴.
> **Human verified** — 인간이 셀 내용을 직접 검수했으면 ✅, 아니면 ⬜ (기본값).
> `analysis/_catalogs/vlm.md` (VLM 후보) 와
> `analysis/_catalogs/dataset.md` (데이터셋) 가 양 옆에서 cross-reference.

---

## Scan 표

| VLA | arXiv (year) | License | Access | 총 파라미터 | Lineage 요약 | Human verified |
|---|---|---|---|---|---|---|
| [π0](#pi0) | [2410.24164](https://arxiv.org/abs/2410.24164) (2024) | Apache-2.0 ✅ | 🟢 [gh:Physical-Intelligence/openpi](https://github.com/Physical-Intelligence/openpi) | 2.6B (2.291B VLM + 0.315B AE) | PaliGemma-2B × OXE + π in-house | ⬜ |
| [π0.5](#pi05) | [2504.16054](https://arxiv.org/abs/2504.16054) (2025) | Apache-2.0 ✅ | 🟢 [gh:Physical-Intelligence/openpi](https://github.com/Physical-Intelligence/openpi) | ~3B (PaliGemma + hierarchical AE) | PaliGemma × π0.5 mix (web + robot) | ⬜ |
| [π0-FAST](#pi0-fast) | [2501.09747](https://arxiv.org/abs/2501.09747) (2025) | Apache-2.0 ✅ | 🟢 [gh:Physical-Intelligence/openpi](https://github.com/Physical-Intelligence/openpi) | 2.6B | PaliGemma-2B × OXE + π (FAST tokenizer) | ⬜ |
| [RT-2](#rt2) | [2307.15818](https://arxiv.org/abs/2307.15818) (2023) | Closed ❌ | 🔴 — Google DeepMind internal | 12B / 55B (PaLI-X variants) | PaLI-X × web VLM + robot co-FT | ⬜ |
| [OpenVLA](#openvla) | [2406.09246](https://arxiv.org/abs/2406.09246) (2024) | MIT ✅ + Llama-2 ✅¹ | 🟢 [gh:openvla/openvla](https://github.com/openvla/openvla) | 7B | Llama-2-7B + DINOv2 + SigLIP × OXE (~970k traj) | ⬜ |
| [Octo](#octo) | [2405.12213](https://arxiv.org/abs/2405.12213) (2024) | Apache-2.0 ✅ | 🟢 [gh:octo-models/octo](https://github.com/octo-models/octo) | 27M / 93M (Small / Base) | (no VLM init — transformer scratch) × OXE (~800k traj) | ⬜ |
| [GR00T N1](#groot-n1) | [2503.14734](https://arxiv.org/abs/2503.14734) (2025) | NVIDIA Research ❌ | 🟢 [gh:NVIDIA/Isaac-GR00T](https://github.com/NVIDIA/Isaac-GR00T) | ~2.2B (1.34B VLM + ~0.9B AE) | Eagle-2 (1.34B VLM) × humanoid traj + human video + synthetic | ⬜ |
| [GR00T N1.5 / N1.7](#groot-n15) | TBD ❓ | NVIDIA Research ❌ | 🟢 [gh:NVIDIA/Isaac-GR00T](https://github.com/NVIDIA/Isaac-GR00T) | TBD ❓ | Eagle-2 × GR00T v1 + additional embodiments | ⬜ |
| [MolmoAct](#molmoact) | [2508.07917](https://arxiv.org/abs/2508.07917) (2025) | Apache-2.0 ✅ | 🟢 [gh:allenai/MolmoAct](https://github.com/allenai/MolmoAct) | ~7B (Molmo-7B-D) | Molmo-7B-D × MolmoAct Dataset (10k Franka / 93 tasks) + OXE | ⬜ |
| [MolmoAct2](#molmoact2) | [2605.02881](https://arxiv.org/abs/2605.02881) (2026) | Apache-2.0 ✅ | 🟢 [gh:allenai/molmoact](https://github.com/allenai/molmoact) | ~7B (Molmo + per-layer KV) | Molmo × BimanualYAM (34.5k / 720h) + DROID-MolmoAct2 + SO100/101 | ⬜ |
| [MolmoBot](#molmobot) | [2603.16861](https://arxiv.org/abs/2603.16861) (2026) | Apache-2.0 ✅ | 🟢 [gh:allenai/molmospaces](https://github.com/allenai/molmospaces) | TBD (Molmo 가족) ❓ | Molmo (추정) × MolmoBot-Data (1.7M sim / Franka FR3 + RB-Y1) | ⬜ |
| [VLM2VLA](#vlm2vla) | [2509.22195](https://arxiv.org/abs/2509.22195) (2025) | TBD ❓ | ❓ — LoRA weights HF 대기 | 12B base + LoRA delta | Gemma-3-12B-IT (LoRA) × BridgeData v2 NL-formatted (FT only) | ⬜ |
| [VLA-Adapter](#vla-adapter) | [2509.09372](https://arxiv.org/abs/2509.09372) (2025) | TBD ❓ | 🟢 [gh:OpenHelix-Team/VLA-Adapter](https://github.com/OpenHelix-Team/VLA-Adapter) | 0.5B (+ adapter) | Prismatic-VLM + Qwen2.5-0.5B × LIBERO + CALVIN (adapter-only) | ⬜ |
| [PriorVLA](#priorvla) | [2605.10925](https://arxiv.org/abs/2605.10925) (2026) | TBD ❓ | ❓ — release 확인 필요 | 7B (OpenVLA base) + Adaptation | OpenVLA (CLIP-B/L + Llama-7B) × Prior frozen + Adaptation (RoboTwin 2.0 + LIBERO) | ⬜ |
| [TwinBrainVLA](#twinbrainvla) | [2601.14133](https://arxiv.org/abs/2601.14133) (2026) | TBD ❓ | ❓ — release 확인 필요 | TBD ❓ | TBD × TBD (LIBERO / RoboCasa fine-tune) | ⬜ |
| [Being-H0](#being-h0) | [2507.15597](https://arxiv.org/abs/2507.15597) (2025) | TBD ❓ | 🟢 [gh:BeingBeyond/Being-H](https://github.com/BeingBeyond/Being-H) | TBD ❓ | TBD (BeingBeyond VLM) × large-scale human videos + 3D physical alignment | ⬜ |
| [Being-H0.5](#being-h05) | [2601.12993](https://arxiv.org/abs/2601.12993) (2026) | Apache-2.0 ✅ | 🟢 [gh:BeingBeyond/Being-H](https://github.com/BeingBeyond/Being-H) | TBD ❓ (Qwen2.5-VL 추정) | TBD × UniHand-2.0 (~35k h × 30 embodiments / 120B tokens) | ⬜ |
| [Xiaomi-Robotics-0](#xiaomi-robotics-0) | [2602.12684](https://arxiv.org/abs/2602.12684) (2026) | TBD ❓ | 🟢 [gh:XiaomiRobotics/Xiaomi-Robotics-0](https://github.com/XiaomiRobotics/Xiaomi-Robotics-0) | 4.7B total | Qwen3-VL-4B-Instruct × ~200M robot timesteps (DROID + MolmoAct + in-house) + 80M+ VL | ⬜ |
| [Genesis AI](#genesis-ai) | — | Closed ❌ | 🔴 — undisclosed | undisclosed | undisclosed × undisclosed | ⬜ |
...
> Human verified · Sources 8개 H4 sub-section 이 보입니다.
...
- **VLM init** 셀의 모델명은 `analysis/_catalogs/vlm.md` 의 행과 1:1 대응 —
  ...
  필요.
- **Training data** 카드의 데이터셋 명은 `analysis/_catalogs/dataset.md`
  의 행과 1:1 대응 — "OXE" → dataset.md OXE 행, "BridgeData v2" →
