...
| `Eq. (2)` LSTM MSE+L2 | `analysis/2511.00139/analysis.md §🔬` | `impl.md §🚧 #5` | 유보 |
| `Eq. (3)` CAE 재구성 | `analysis/2511.00139/analysis.md §🔬` | `impl.md §🚧 #4` | 유보 |
| `Eq. (14)` 비축적 corrective | `design.md §📊` | `impl.md §🚧 #6` | 유보 |
| `Eq. (4)` / `Eq. (8)` 입력 계약 | `design.md §🧮` | `impl.md §🚧 #4` (촉각) / data layer | 유보 |
