...
CONTEXT (read-only):
- research_context_P2.md        — source of truth, P2 scope only
...
- research_log/YYYY-MM-DD-P2.md — this pillar's recent reports (last
                                   ~2 weeks, ~4 files), for de-duplication only

This branch operates in P2-only scope: read research_context_P2.md,
not the full research_context.md. Never edit any context file.
research_context_P2.md is human-owned; if a pinned paper should
...
after the intro blockquote and right before `## 📋 Scout Methodology`.
  ...
  - Derive the meaning from research_context_P2.md (do not invent):
...
- Do not recommend any paper already covered in this pillar's recent
  reports — the last ~2 weeks (~4 files `research_log/YYYY-MM-DD-P2.md`).
- Do not edit research_context_P2.md. If a pinned paper should be
