...
| 파일 | 생성 주체 | 성격 |
|---|---|---|
| `P#_BRIEF.md` | `probe-p#-synthesis` Routine (월 1회) | `context/P#.md` 의 Decision Log 섹션 + Tracked Literature(핀 논문) 섹션만 읽고 재생성 |
...
- 입력 = `context/P#.md` 의 Decision Log + Tracked Literature 두 섹션 **만** — 외부 검색·MCP·`curl` 일절 없음 (인용 조작 원천 차단).
