...
> Owns the P2 Decision Log, Tracked Literature, Anti-topics, Competitor
> Monitoring, Researchers, and Curated Lists. P2 owns **D8–D12**; cross-cutting
...
- Router-based MoE for action selection (different pattern; DexReMoE monitoring is the §7 exception)
...
## 8. P2 Curated External Lists to Monitor [AGENT-INPUT]
