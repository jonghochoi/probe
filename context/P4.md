...
- Continual-learning / PEFT outside the VLA-preservation context (cross-pollination only — `context/MASTER.md` §7)
...
>
> 2026-05 rebalance: VLA-Adapter / PriorVLA / Multi-Embodiment Pretraining Data demoted from pins (VLA-Adapter and PriorVLA stay tracked). Slots reused for GR00T N1, Being-H0.5, Xiaomi-Robotics-0 to widen lineage coverage (D19b).
>
...
>
> 2026-06 rebalance: pinned UAM ([arXiv:2605.15735](https://arxiv.org/abs/2605.15735)) + ConSFT ([arXiv:2605.08879](https://arxiv.org/abs/2605.08879)). Demoted (추적 유지): RT-2 ([arXiv:2307.15818](https://arxiv.org/abs/2307.15818)) — web/robot co-FT; MolmoAct2 ([arXiv:2605.02881](https://arxiv.org/abs/2605.02881)) — per-layer KV-cache, still in P1 §5 methodology.
...
anchor (Identity, Pillars overview, Venue, Cross-pollination), consult
`context/MASTER.md` and the other `context/P#.md`.*
