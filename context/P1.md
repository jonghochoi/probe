...
> Owns the P1 Decision Log, Tracked Literature, Anti-topics, Competitor
> Monitoring, Researchers, and Curated Lists. P1 owns **D1–D7**; cross-cutting
...
- Router-based MoE for action selection (different pattern; DexReMoE monitoring is the exception — §7)
...
> **2026-06 rebalance** — pinned Dexora ([arXiv:2605.18722](https://arxiv.org/abs/2605.18722)) + PriorVLA ([arXiv:2605.10925](https://arxiv.org/abs/2605.10925)). Demoted (추적 유지): HEX ([arXiv:2604.07993](https://arxiv.org/abs/2604.07993)) → §7 Competitor; DexterityGen ([arXiv:2502.04307](https://arxiv.org/abs/2502.04307)) → tracked as Identity antagonist + P3 §7.
...
## 8. P1 Curated External Lists to Monitor [AGENT-INPUT]
...
(Identity, Pillars overview, Venue, Cross-pollination, cross-pillar Researchers),
