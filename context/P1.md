...
> this file. Findings go to `scouting/YYYY-MM-DD-P1.md` (one per run).
...
**Literature anchor**: π0/π0.5 (backbone); TwinBrainVLA (AsyMoT), DexterityGen (bounded precedent), LaMP / HEX (dual-expert), Shared-Autonomy Arm-Hand VLA / DexGrasp-VLA (anatomical arm/hand split), Demystifying Action Space Design (D2 evidence). See §6.
...
| **Shared-Autonomy Arm-Hand VLA (DexGrasp-VLA)** | [2511.00139](https://arxiv.org/abs/2511.00139) | Anatomical arm/hand split + Arm-Hand Feature Enhancement | Split realized via shared-autonomy data collection, not fully end-to-end autonomous decoder | CP1 architecture comparison; any in-hand-rotation / articulated-tool extension |
