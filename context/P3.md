...
> Owns the P3 Decision Log, Tracked Literature, Anti-topics, Competitor
> Monitoring, Researchers, and Curated Lists. P3 owns **D13–D18**; cross-cutting
...
## 6. P3 Researchers & Groups to Follow [LIVING]
...
## 7. P3 Competitor / Kindred Monitoring [LIVING] [AGENT-INPUT]

System0-necessity tests and bounded-RL precedents — reviewed when Tracked Literature rebalances.
...
## 8. P3 Curated External Lists to Monitor [AGENT-INPUT]
...
cross-pillar Researchers), consult `context/MASTER.md` and the other
`context/P#.md`.*
